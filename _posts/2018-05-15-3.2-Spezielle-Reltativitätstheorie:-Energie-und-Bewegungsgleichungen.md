...
- $$ (a^\mu) =  \begin{pmatrix} \gamma^4 \dfrac{\vec v \cdot \vec a}{c^2} \\ \gamma^2 \vec a + \gamma^4 \dfrac{\vec v \cdot \vec a}{c^2} \vec v \end{pmatrix} \Rightarrow \vec F = m \gamma (v) \vec a + m \gamma^3 (v) \dfrac{\vec v \vec a }{c^2}  $$
