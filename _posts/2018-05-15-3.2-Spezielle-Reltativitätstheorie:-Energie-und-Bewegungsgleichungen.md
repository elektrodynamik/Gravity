...
Mit $$ \dfrac{\rm d }{\rm d \tau} = \dfrac{\rm d t}{\rm d \tau} \dfrac{\rm d }{\rm d t} = \gamma \dfrac{\rm d }{\rm d \tau}  $$ folgt $$ (F^0,\vec F)^T = (F^\mu) = ( \gamma \dfrac{\rm d }{\rm d \tau} p^0, \gamma \dfrac{\rm d }{\rm d \tau} \vec p)^T  $$