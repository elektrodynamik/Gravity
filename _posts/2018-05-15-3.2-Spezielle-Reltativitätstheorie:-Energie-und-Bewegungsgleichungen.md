...
- relativistische Dispersionsrelation: Taylor-Entwicklung von $$ E = \sqrt{m^2 c^4 +\vec p^2 c^2} = m c^2 \sqrt{1 + \frac{\vec p^2}{m^2 c^2} }  =m c^2 ( 1 + \frac{1}{2} \dfrac{\vec p^2}{m^2 c^2} - \frac{1}{8} \frac{\vec p^2}{m^2 c^2} + \dots ) = mc^2 + \frac{p^2}{2} - \frac{ \vec p^2)^2}{8 m^3 c^2 + \dots $$
