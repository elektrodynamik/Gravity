...
6. Makroskopische Energie Bilanz: $$\partial_t \langle \epislon_{\rm mech.} = \langle \vec j_f \rangle \langle \vec E \rangle  \\ = \dfrac{1}{4\pi} \{ \langle \vec E \rangle \langle \vec D \rangle + \langle \vec H \rangle$$