...
$$ \Rightarrow  \vec \nabla \wedge \langle \vec B(\vec x,t) \rangle -\partial_{ct} \langle \vec E(\vec x,t) \rangle  \\ = \dfrac{4\pi}{c} \rangle \vec j_{\rm tot.} (\vec x,t)\rangle \\ = \dfrac{4\pi}{c} \langle \vec j_f (\vec x,t) \rangle +\dfrac{4\pi} $$