...
6. Makroskopische Energie Bilanz: $$\partial_t \langle \epislon_{\rm mech.} = \langle \vec j_f \rangle \langle \vec E \rangle  \\ \langle \epsilon_{\rm em.} \rangle = \dfrac{1}{4\pi} \{ \langle \vec E \rangle \langle \vec D \rangle + \langle \vec H \rangle \langle \vec B \rangle \} $$

$$ \vec S = \dfrac{c}{4\pi} \langle \vec E \rangle \wedge \langle \vec H \rangle \\ \partial_t \langle \epsilon_{\rm mech} \rangle + \partial_t \langle \epsilon_{\rm em} \rangle $$