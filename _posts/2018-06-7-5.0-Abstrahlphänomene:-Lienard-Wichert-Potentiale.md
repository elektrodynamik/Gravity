...
$$ \phi_{\rm ret} (\vec x,t) = \frac{q}{c} \int {\rm d} t' \dfrac{ c \rho(\vec x',t') }{\mid \vec x - \vec x'\mid} \delta(t - t'_ {\rm ret}, $$ 

$$ \vec A_{\rm ret} (\vec x,t) = \frac{q}{c} \int {\rm d} t' \dfrac{ \dot{\vec x(t')} }{\mid \vec x - \vec x'\mid } \delta(t - t' + \dfrac{\mid\vec x - \vec x'\mid}{c} ), $$ 
