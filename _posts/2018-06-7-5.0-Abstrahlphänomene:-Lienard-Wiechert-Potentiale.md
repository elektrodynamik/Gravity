...
$$\text{ 'Larmor'}  \boxed{ \Rightarrow P = \frac{2}{3} \frac{q^2}{c} \dot{\vec \beta }^2 } $$

Grenzfall $$ \vec \beta \parallel \vec \dot{\vec \beta } $$ ( 'Linearbeschleuniger' )
...
$$ P = \frac{2}{3} \frac{q^2}{m^2 c^3} \frac{ {\rm d} P_{\rm NR} }{ {\rm d} t } \frac{ {\rm d} P_{\rm NR} }{ {\rm d} t } \stackrel{e.g}{\to} -\frac{2}{3} \frac{q^2}{m^2 c^3} \frac{ {\rm d} P^\mu }{ {\rm d} \tau } \frac{ {\rm d} P_\mu }{ {\rm d} t } $$