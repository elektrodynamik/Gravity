...
Berechne die Spannung $$ V(t) $$ für $$ I \to I(t) $$ mit quasistatischer Näherung ($$\partial_{ct} \vec E \approx 0 ) \\ \vec B(t) = \dfrac{4 \pi}{c} \dfrac{N}{L} I(t) \vec e_z, \\ V(t) \stackrel{\rm (II)}{=} - $$
