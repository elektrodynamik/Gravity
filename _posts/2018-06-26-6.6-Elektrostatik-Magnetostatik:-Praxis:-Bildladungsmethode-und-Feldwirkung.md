...
Berechne die Spannung $$ V(t) $$ für $$ I \to I(t) $$ mit quasistatischer Näherung ($$\partial_{ct} \vec E \approx 0 ) \\ \vec B(t) = \dfrac{4 \pi}{c} \dfrac{N}{L} I(t) \vec e_z, \\ V(t) \stackrel{\rm (II)}{=} N \int_F {\rm d}\vec F -\partial_{ct} \vec B = - \dfrac{4 \pi^2}{c^2} \dfrac{N^2 R^2}{L} $$
