...
$$\dfrac{1}{\mid \vec x - \vec x'\mid} = ? \\\vec x =  \begin{pmatrix} \cos \phi \sin\theta \\ \sin \phi \sin \theta \\ \cos \theta \end{pmatrix} \\ \vec x ' = \begin{pmatrix} \cos \phi \sin\theta \\ \sin \phi \sin \theta \\ \cos \theta \end{pmatrix} $$