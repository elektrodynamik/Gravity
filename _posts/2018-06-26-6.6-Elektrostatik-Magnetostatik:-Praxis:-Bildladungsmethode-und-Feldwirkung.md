...
$$ \vec B(0,0,z) = \dfrac{I}{c} \int_0^{2\pi} {\rm d} s \dfrac{\vec l(s) \wedge \vec t(s)}{\mid z \vec e_z - \vec l(s) \mid^3 } = \dfrac{2\piIR^2}{c} \dfrac{1}{(R^2 + z^2)^{\dfrac{3}{2}} \vec e_z $$

- Magnetfel einer Spule