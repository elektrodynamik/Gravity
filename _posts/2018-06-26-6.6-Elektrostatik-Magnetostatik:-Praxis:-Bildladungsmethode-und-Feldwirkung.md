...
Feinere Wicklung: $$ \sum \to n \int {\rm d} z, \, n = \dfrac{N}{L} \\ \vec B(0,0,0) = \dfrac{2\pi I R^2}{c} n \int_{-\frac{L}{2}}^{\frac{L}{2}} \dfrac{ {\rm d} z }{( R^2 + z^2)^{\frac{3}{2} } } \\ \dfrac{L}{(R^2 + \frac{L^2}{4})^{\frac{1}{2} }$$ 
