...
Aus $$ -\partial_x \phi\mid_{x = R} = 4 \pi \sigma, \sigma(\alpha) = ... = \dfrac{-q}{4 \pi a R} \cdot \dfrac{1 - \frac{R^2}{a^2}}{( 1- \frac{2R}{a} \cos(\alpha) + \frac{R^2}{a^2})^{\frac{3}{2}} $$
...
$$ \Delta (\dots) = \frac{1}{r} \partial^2_{r} r (\dots) + \frac{1}{r^2 \sin \theta} \partial_\theta ( \sin \theta \partial_\theta (\dots) )$$