...
$$ \Rightarrow  {\rm d}^3 \vec j(\vec x') = I \vec l(s) {\rm d} s \\ \Rightarrow \vec \mu = \dfrac{1}{2c} \int {\rm d}^3 x' \vec x' \wedge \vec j(\vec x') = \dfrac{I}{2c} \int_0^{2\pi} {\rm d} \dfrac{\vec l(s) \wedge \vec t(s) }{R^2 \vec e_z}$$