...
$$ c \Delta t = \gamma c \Delta t' + \beta \gamma \cancelto{0}{\Delta x'} \\
\Delta t = \gamma \Delta t' $$

Eine Einheitssekunde in $$S'$$ ist nicht gleichzeitig in S. Transformation auf 0 in S via shift. $$ \to $$ Zeitintervall in S. 