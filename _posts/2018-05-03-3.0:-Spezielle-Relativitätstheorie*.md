...
$$ \boxed{\rm  Postulate} \\ (1) Relativitätsprinzip: Physikalische Gesetze sind in allen Inertialsystemen gleich; so als ob es kein ausgezeichnetes Intertialsystem gibt. \\ (2) Konstanz der Lichtgeschwindigkeit (c): Die Lichtgeschwindigkeit ist unnabhängig vom Bewegungszustand von Quelle und Empfänger. } $$
