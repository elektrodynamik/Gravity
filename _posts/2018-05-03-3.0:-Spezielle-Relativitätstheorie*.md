...
Einen bewegten Punkt im $$ \mathbb{R}^3 $$ finden wir zu einem beliebigen Zeitpunkt $$ t $$ durch folgenden Parametrisierungen, wobei die ungestrichenen Koordinaten im ruhenden System gelten und die gestrichenen im bewegten System gelten.

$$ x = v t  \Leftrigharrow x' = 0 \\ x = 0 \Leftrigharrow x' = - v t \\ $$
