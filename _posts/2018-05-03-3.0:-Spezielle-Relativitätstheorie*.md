...
Eine ausführliche Beschreibung des Paradoxons ist [hier](https://de.wikipedia.org/wiki/Paradoxon_der_Längenkontraktion "hier" ) nachzulesen.
...
$$ \frac{x}{\beta} = 4 - x  \to x = 3/2$$

$$ \to $$ Minimal Hallenlänge wäre $$ 4 - x = 2.5 $$ [m]
