...
$$ \vec d = \frac{i}{2 \omega} I_0 L \vec e_z , \mid \vec n \wedge \vec d \mid^2 = \mid \vec n \mid^2 \mid \vec d\mid^2 \sin^2 \theta = \dfrac{I_0^2 L^2 }{4 \omega^2} \sin^2\theta \to \dfrac{ {\rm d} \bar{P} }{ {\rm d} \Omega } = \drac{c k^4}{8 \pi} \dfrac{I_0 k^2}{4 \omega^2} \sin \theta^2 = \dfrac{I_0^2 \omega^2 L^2}{32 \pi c^3} \sin^2 \theta $$
...
$$ \Rightarrow \vec n \wedge \vec d = q R_0 \begin{\pmatrix} -i \cos \theta \\ \cos \theta \\ (i \cos \varphi - \sin \phi) \sin \theta $$

$$ \mid \vec n \wedge \vec d \mid^2 = \cos^2 \theta + \cos^2 \theta + \sin^2 \theta = 1 + \cos^2 \theta $$

$$ \frac{ {\rm d} \vec P }{ {\rm d} \Omega }  = \dfrac{c k^4}{8\pi} q^2 R_0^2 (1 + \cos^2 \theta ) = \dfrac{ \omega^4} {8 \pi c^3} $$