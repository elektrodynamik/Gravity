...
$$ \vec d = \frac{i}{2 \omega} I_0 L \vec e_z , \mid \vec n \wedge \vec d \mid^2 = \mid \vec n \mid^2 \mid \vec d\mid^2 \sin^2 \theta = \dfrac{I_0^2 L^2 }{4 \omega^2} \sin^2\theta \to \dfrac{ {\rm d} \bar{P} }{ {\rm d} \Omega } = \drac{c k^4}{8 \pi} \dfrac{I_0 k^2}{4 \omega^2} \sin \theta^2 = \dfrac{I_0^2 \omega^2 L^2}{32 \pi c^3} $$