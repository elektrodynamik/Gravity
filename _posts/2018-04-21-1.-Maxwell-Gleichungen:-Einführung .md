...
----
 _Bemerkung: Die Gleichungen sind so zu verstehen, dass $$ \vec \nabla $$ auf $$ \vec E $$ angewendet und am Punkt $$(\vec x,t)$$ ausgwertet wird. $$ \wedge $$ ist der Hodge-Stern-Operator und in Fall $$ \mathbb{R}^3 $$ gilt: $$ \wedge $$ = $$ \times $$_
...
$ \vec F = q_\text{cgs}\left(\vec E_\text{cgs} + \frac{\vec \dot{x}}{c}\times \vec B_\text{cgs}\right)$$, 
