...
Stokes auf $$ IV' \to [\vec H^{(2)} - \vec H^{(1)} ] \vec t = \dfrac{4\pi}{c} k \ (Flächenstromdichte gemäß Abb.)  $$
...
---
![snell1.jpg]({{site.baseurl}}/_assets/snell1.jpg)
![snell2.jpg]({{site.baseurl}}/_assets/snell2.jpg)
![diam.jpg]({{site.baseurl}}/_assets/diam.jpg)
