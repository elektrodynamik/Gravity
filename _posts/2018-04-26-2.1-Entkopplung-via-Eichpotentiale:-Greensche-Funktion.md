...
$$ \dfrac{2c}{\pi \Delta x} \int_0^{\infty} {\rm d} k \sin(ck \Delta t) \sin(k \Delta x) \\ \stackrel{\lambda = ck}{=} \dfrac{1}{ \pi \Delta x} \int_{-\infty}^{\infty} {\rm d} \lambda \sin(\lambda \Delta t) \sin(\lambda \dfrac{\Delta x}{c}) \\ \stackrel{ \rm Trig.}{=} \dfrac{1}{2\pi \Delta x}  \int_{-\infty}^{\infty} {\rm d} \lambda \{ \cos ( \lambda [ \Delta t - \dfrac{\Delta x}{c}] ) -  \cos (\lambda [ \Delta t + \dfrac{\Delta x}{c} ] \} \\ \stackrel{\rm sym.}{=} \dfrac{1}{2 \pi \Delta x} \int_{-\infty}^{\infty} {\rm d} \lambda \{ e^{i\lambda[\Delta t - \dfrac{\Delta x}{c} ]} - e^{i\lambda[\Delta t + \dfrac{\Delta x}{c} ]} \} \\ = \dfrac{1}{\Delta x} \{ \delta (\Delta t - \dfrac{\Delta x}{c} ) - \delta ( \Delta t + \dfrac{\Delta x}{c} ) \}$$ 
...
$$ \boxed{\phi_{\rm ret.} (\vec x,t) = \int {\rm d}^3 x' {\rm d} t' \dfrac{ \rho (\vec x,t') \delta(t' - t_{\rm ret.}) }{\mid\vec x - \vec x'\mid} \\ \vec A_{\rm ret.} (\vec x,t) = \int {\rm d}^3 x' {\rm d} t' \dfrac{ \vec j (\vec x,t') \delta(t' - t_{\rm ret.}) }{\mid\vec x - \vec x'\mid} } $$ 