...
$$ \square f_{\rm hom.} (\vec x,t) = 0 \Leftrightarrow (-\Delta + \partial_{ct}^2) f_{\rm hom.} = 0 \Leftrightarrow (k^2 - \frac{\omega^2}{c^2}) \hat{f}_{\rm hom.} (\vec k,\omega) = 0 \\ \rightarrow \hat{f} (\vec k, \omega) = 0 $$ _,_außer bei $$(k^2 - \frac{\omega^2}{c^2}) = 0 $$
