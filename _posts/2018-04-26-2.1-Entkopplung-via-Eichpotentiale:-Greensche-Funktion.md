...
$$ \rightarrow {\rm d}^3 k $$ außen, da innen Pole bei $$ \omega = \pm ck, k = \mid \hat{k} \mid  \\ \rightarrow  \hat{f} (\vec k,\omega) = \hat{f_+}(\vec k) \delta (\omega - ck) + \hat{f_-} \delta(\omega +ck) $$ 
...
$$ f(x,t) = \frac{1}{2} [ u(x+ct) + u(x-ct) ] + \frac{1}{2} \int_{x-ct}^{x+ct} v(\bar{x}) {\rm d} \bar{x} \\ \partial_{x}^2 f = \frac{1}{2} [ u''(x+ct) + u''(x-ct) ] + \frac{1}{2} [\partial_x v(x+ct) - \partial_x v(x-ct) ] \\ \partial_{ct} f = \frac{1}{2} [ u'(x+ct) - u'(x-ct) ] + \frac{1}{2} [ v(x+ct) - v(x-ct) \cdot (-1) ] \\ \partial_{ct}^2 f = \frac{1}{2} [ u''(x+ct) + u''(x-ct) ] + \frac{1}{2} [ v'(x+ct) - v'(x-ct) - \frac{1}{2} v'(x-ct)]  $$
