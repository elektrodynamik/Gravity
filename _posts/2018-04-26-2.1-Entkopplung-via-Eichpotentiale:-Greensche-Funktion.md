...
$$ f(x,t) = \frac{1}{2} [ u(x+ct) + u(x-ct) ] + \frac{1}{2} \int_{x-ct}^{x+ct} v(\bar{x}) {\rm d} \bar{x} \\ \partial_{x}^2 f = \frac{1}{2} [ u''(x+ct) + u''(x-ct) ] + \frac{1}{2} [\partial_x v(x+ct) - \partial_x u(x-ct) ] \\ \partial_{ct} f = \frac{1}{2} [ u'(x+ct) - u'(x-ct) ] + \frac{1}{2} [ v(x+ct) - u(x-ct) \cdot (-1) ] \\ \partial_{ct}^2 f = \frac{1}{2} [ u''(x+ct) + u''(x-ct) ] + \frac{1}{2} [ v'(x+ct) - v'(x-ct) - \frac{1}{2}]  $$
