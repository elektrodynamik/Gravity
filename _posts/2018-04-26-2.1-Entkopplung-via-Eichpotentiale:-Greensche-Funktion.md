...
Problem: $$ {\rm d}^3 k$$ ist kein Problem, aber für das innere Integral $$ {\rm d} \omega $$ bei $$ \omega > \pm ck $$ sind Pole ([propagator](https://ncatlab.org/nlab/files/ContourForAdvancedPropagator.png "Skizze")).  
