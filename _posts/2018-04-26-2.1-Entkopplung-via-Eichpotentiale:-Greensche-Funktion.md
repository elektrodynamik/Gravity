...
$$(\vec k^2 - \dfrac{\omega^2}{c^2}) \hat{G}(\vec k,\omega) = \dfrac{4\pi}{(2\pi)^2} \rightarrow \hat{G}(\vec k,\omega) = \dfrac{1}{\pi} (k^2 - \dfrac{\omega^2}{c^2})^{-1} \\ = \dfrac{1}{\pi} \dfrac{c}{(ck-\omega)(ck + \omega)} = \dfrac{1}{2\pi} \frac{c}{k} \dfrac{1}{(\omega + ck) (\omega - ck) } $$ 
