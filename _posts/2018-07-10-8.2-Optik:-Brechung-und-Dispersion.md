...
$$ \psi(z,t) = \dfrac{1}{\sqrt{2\pi}} \int_{-\infty}^{\infty} {\rm d} k \Delta e^{\frac{-\Delta^2 (k-k_0)^2}{2}} e^{i[kz - \omega_0(1 + \frac{a^2k^2}{2})t]} \\ \stackrel{\rm qE}{=} \dfrac{\Delta}{\sqrt{2\pi}} e^{- \frac{ z - \omega_0 a^2 t k_0 $$