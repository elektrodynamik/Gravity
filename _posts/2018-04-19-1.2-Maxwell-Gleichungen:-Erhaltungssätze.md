...
$$ \bar{E}_{\rm EM} = \dfrac{1}{T} {\int_t}^{\ t+T} E_{\rm EM} (\vec x,t) = \dfrac{1}{16 \pi} [ \mid  \vec E(\vec x) \mid^2] + [ \mid  \vec B \mid^2] $$

$$ \bar{E}_{\rm EM} = \dfrac{1}{T} {\int_t}^{\ t+T} E_{\rm EM} (\vec x,t) = \dfrac{1}{16 \pi} [\vec E ] + [ \mid  \vec B ] $$