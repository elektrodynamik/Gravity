...
Für $$ | \vec E|, |\vec B| \propto \dfrac{1}{r^{1 + \epsilon} $$ '_überlebt_' für $$ V \to \inf $$ nur der 2te Term. 
...
$$ \dfrac{\rm d}{\rm dt} (E_{\rm mech.} + E_{\rm EM}) + \int_{\partial V} {\rm d} \vec \sigma \vec S = 0  $$
