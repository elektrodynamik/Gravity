...
$$ \dfrac{\rm}{d t} E_{\rm mech.} = - \dfrac{c}{4 \pi} \int_{\partial V = F} \rm d \vec \sigma [\vec E \wedge \vec B ] (\vec x, t) - \dfrac{1}{8 \pi} \int_V d^3 x \partial_t [\vec E^2 + \vec B^2] (\vec x,t) $$
