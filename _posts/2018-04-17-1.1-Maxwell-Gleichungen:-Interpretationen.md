...
$$ V$$: Volumen mit Rand $$\partial V = F, \partial \lor V \eq \{ \} $$

$$ F:$$ Fläche mit Rand $$\partial F = \Gamma \lor \partial F \eq \{ \} $$

$$ \Gamma$$: Kurve mit Rand $$ \partial \Gamma \lor \Gamma \eq \{ \} $$, d.h. geschl.
