...
$$\f \in \mathcal{C}^{\infty}(\mathbb{R}^n):$$ bel. oft stet. differenzierbare Funktion.

Distribution: Funktional $$ \mathcal{C}^{\infty}(\mathbb{R}^n) \rightarrow  \mathbb{R} \lor \mathbb{C}$$
