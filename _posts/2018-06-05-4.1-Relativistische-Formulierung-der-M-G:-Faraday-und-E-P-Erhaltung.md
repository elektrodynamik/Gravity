...
- Zu gegebenen ensorfeld $$ T^{\star \star} $$ resp. $$T_\star^{\ \star}  $$, resp. $$ T^\star_{ \ \star} $$. gibt es zyklische Spuren $$ T_\alpha^{ \ \alpha} , T_\alpha^{\ \beta} T_\beta^{ \ \alpha}, T_\alpha^{\ \beta} T_\beta^{ \ \gamma} T_\gamma^{ \ \alpha } $$  