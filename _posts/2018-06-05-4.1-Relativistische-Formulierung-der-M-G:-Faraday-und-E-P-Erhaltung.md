...
wobei sich $$ \parallel, \perp $$ auf $$ \vec v $$ bezieht; Trafo von $$ \vec E $$ und $$ \vec B $$ bzw. $$ {\rm d} \vec l_{\parallel} = \frac{1}{\gamma} {\rm d} \vec l'_ {\parallel},  {\rm d} \vec l_{\perp} = {\rm d} \vec l'_ {\perp} $$    