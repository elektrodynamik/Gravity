...
$$ f(\vec x') = x_k' x_l' \to \int {\rm d}^3 x' x_k'x_k' j_k + x_k'j_l = 0 \\ \to \int {\rm d}^3 x' x_l' j_k = \dfrac{1}{2} \int {\rm d}^3 x' (x_l'j_k - x_k' j_l) \\ \to \sum_l \int {\rm d}^3 x' x_l x_l' j_k = \frac{1}{2} \int {\rm d}^3 x (x_l x_l' j_k - x_l x_l' j_l)$$
