...
[Perfekter Leiter](https://raw.githubusercontent.com/elektrodynamik/elektrodynamik.github.io/master/_assets/perfleit.jpg "Perfekter Leiter: Tangevektor t, Normalenvektor n, E-Feldstärke E")
...
(i) $$ \vec E_{\perp} (\vec x) = \vec E(\vec x) \vec n(\vec x) = 4 \pi$$