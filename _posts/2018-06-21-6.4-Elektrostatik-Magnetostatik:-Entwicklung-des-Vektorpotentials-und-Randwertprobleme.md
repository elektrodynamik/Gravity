...
![Endliche Ladungsverteilung mit Volumen V](https://raw.githubusercontent.com/elektrodynamik/elektrodynamik.github.io/master/_assets/rwpvert.jpg = 250x250)
...
- Demnach folgt $$ \psi(\vec x') $$ mit ($$ \dfrac{1}{\mid\vec x - \vec x'\mid}$$
