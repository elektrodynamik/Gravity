...
$$ \dfrac{1}{\mid \vec x - \vec x'\mid } = \dfrac{1}{\vec x} + \sum_i \vec x'_ i \partial_{x'_ i} \dfrac{1}{\mid \vec x -\vec x'\mid}\mid_{\vec x' = 0} + \dfrac{1}{2} \sum_{i,j} \vec x_i' \vec x_j' \partial_i' \partial_j' \dfrac{1}{\mid \vec x - \vec x'\mid}\mid_{\vec x'=0}$$