...
$$  \sum_{i,j} \dfrac{3 x_i x_j - \mid \vec x \mid^2 \delta_{i,j} }{\mid 6 \vec x\mid^5} \int d^3 x' \mid \vec x'\mid^2 \delta_{i,j} \rho(\vec x') = \sum_i \dfrac{3 x_i x_j - \mid \vec x \mid^2 }{\mid 6 \vec x\mid^2}  $$
