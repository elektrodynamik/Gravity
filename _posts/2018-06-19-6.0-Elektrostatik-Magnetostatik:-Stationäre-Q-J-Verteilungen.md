...
$$ \Rightarrow \dfrac{1}{\mid \vec x - \vec x'} = \dfrac{1}{\mid \vec x\mid } + \sum_i \dfrac{x_i' x_i}{\mid \vec x \mid^3} + \dfrac{1}{2} \sum_{i,j} x_i' x_j' (\dfrac{ 3 x_i x_j}{\mid \vec x\mid^5} - \dfrac{\delta_{ij}}$$